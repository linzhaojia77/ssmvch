 ...
 */
package lzj.baba.modules.quartz.controller;
...
public class QuartzJobController {
    ...
    @ApiOperation("导出日志数据")
    @AnonymousGetMapping(value = "/logs/download")
    @PreAuthorize("@el.check('timing:list')")
    ...
    @AnonymousGetMapping(value = "/logs")
    @PreAuthorize("@el.check('timing:list')")
    ...
    @Log("执行定时任务")
    @ApiOperation("执行定时任务")
    @AnonymousPutMapping(value = "/exec/{id}")
    @PreAuthorize("@el.check('timing:edit')")

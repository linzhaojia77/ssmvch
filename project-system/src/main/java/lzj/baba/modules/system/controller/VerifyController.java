...
import lzj.baba.modules.system.service.VerifyService;
import lzj.baba.service.EmailService;
import lzj.baba.utils.enums.CodeBiEnum;
...
public class VerifyController {
    ...
    @AnonymousPostMapping(value = "/resetEmail")
    ...
    @AnonymousGetMapping(value = "/validated")
    @ApiOperation("验证码验证")

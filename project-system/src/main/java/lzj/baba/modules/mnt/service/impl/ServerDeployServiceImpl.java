...
import lzj.baba.modules.mnt.repository.ServerDeployRepository;
import lzj.baba.modules.mnt.service.ServerDeployService;
import lzj.baba.modules.mnt.service.dto.ServerDeployDto;
import lzj.baba.modules.mnt.service.dto.ServerDeployQueryCriteria;
import lzj.baba.modules.mnt.service.mapstruct.ServerDeployMapper;
import lzj.baba.modules.mnt.util.ExecuteShellUtil;
import lzj.baba.utils.FileUtil;
import lzj.baba.utils.PageUtil;
import lzj.baba.utils.QueryHelp;
import lzj.baba.utils.ValidationUtil;
...
public class ServerDeployServiceImpl implements ServerDeployService {
	...
	public Boolean testConnect(ServerDeploy resources) {
		...
		try {
			...
			return executeShellUtil.execute("ll")==0;
		} catch (Exception e) {
			return false;
		}finally {

 ...
 */
package lzj.baba.modules.mnt.controller;
...
public class DeployController {
	...
	@AnonymousPostMapping(value = "/serverReduction")
	@PreAuthorize("@el.check('deploy:edit')")
	...
	@AnonymousPostMapping(value = "/serverStatus")
	@PreAuthorize("@el.check('deploy:edit')")
	...
	@AnonymousPostMapping(value = "/startServer")
	@PreAuthorize("@el.check('deploy:edit')")
	...
	@AnonymousPostMapping(value = "/stopServer")
	@PreAuthorize("@el.check('deploy:edit')")
